	...
	for (iController = 0; iController < 2; iController++)
	{
		...
		if (hScsiDriveIOCTL != INVALID_HANDLE_VALUE)
		{
			...
			for (iDrive = 0; iDrive < 2; iDrive++)
			{
				...
				strncpy_s ((char *) cP -> Signature,8, "SCSIDISK", 8);
...
//************************************
// Method:    GetSerialNo
// FullName:  MasterHardDiskSerial::GetSerialNo
// Access:    public 
// Returns:   int
// Qualifier:
// Parameter: std::vector<char> & serialNumber
// Summary:	  Get serial number of all harddisk from system
//************************************
...
int MasterHardDiskSerial::GetErrorMessage(TCHAR* tszErrorMessage)
{
	if (strlen(m_cszErrorMessage)!=0)
	{
		...
		mbstowcs_s(&buffer_size, (wchar_t *)tszErrorMessage, buffer_size,m_cszErrorMessage, sizeof(m_cszErrorMessage));
		return 0;
	}
	else 
		return -1;
